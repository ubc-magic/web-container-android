...
/*			else if (v.getId() == R.id.multiselect_button)
			{
				if(multi_select_flag) {
					mDelegate.killMultiSelect(true);				
	...
	*/
			 ...
			 */
			/*
			else if (v.getId() == R.id.hidden_attach)
			{
			...
			else if (v.getId() == R.id.hidden_move)
			{
			}
			else if (v.getId() == R.id.hidden_copy)
			{
				// check if user selected objects before going further 
				if(mMultiSelectData == null || mMultiSelectData.isEmpty()) {
					mDelegate.killMultiSelect(true);
...
*/
/*			else if (v.getId() == R.id.hidden_delete)	
				// check if user selected objects before going further 
				if(mMultiSelectData == null || mMultiSelectData.isEmpty()) {
					mDelegate.killMultiSelect(true);
					break;
